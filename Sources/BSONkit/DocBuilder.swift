...
struct DocBuilder {
    ...
    static func buildBlock<T0, T1, T2, T3> (_ t0: T0, _ t1: T1, _ t2: T2, _ t3: T3) -> some BinaryConvertible
    where T0 : BinaryConvertible, T1 : BinaryConvertible, T2 : BinaryConvertible, T3 : BinaryConvertible {
        Tuple4(t0, t1, t2, t3)
    }

    static func buildBlock<T0, T1, T2, T3, T4> (_ t0: T0, _ t1: T1, _ t2: T2, _ t3: T3, _ t4: T4) -> some BinaryConvertible
    ...
    static func buildBlock<T0, T1, T2, T3, T4, T5> (_ t0: T0, _ t1: T1, _ t2: T2, _ t3: T3, _ t4: T4, _ t5: T5) -> some BinaryConvertible
    ...
    static func buildBlock<T0, T1, T2, T3, T4, T5, T6> (_ t0: T0, _ t1: T1, _ t2: T2, _ t3: T3, _ t4: T4, _ t5: T5, _ t6: T6) -> some BinaryConvertible
    ...
    static func buildBlock<T0, T1, T2, T3, T4, T5, T6, T7> (_ t0: T0, _ t1: T1, _ t2: T2, _ t3: T3, _ t4: T4, _ t5: T5, _ t6: T6, _ t7: T7) -> some BinaryConvertible
    ...
    static func buildBlock<T0, T1, T2, T3, T4, T5, T6, T7, T8> (_ t0: T0, _ t1: T1, _ t2: T2, _ t3: T3, _ t4: T4, _ t5: T5, _ t6: T6, _ t7: T7, _ t8: T8) -> some BinaryConvertible
    ...
    static func buildBlock<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> (_ t0: T0, _ t1: T1, _ t2: T2, _ t3: T3, _ t4: T4, _ t5: T5, _ t6: T6, _ t7: T7, _ t8: T8, _ t9: T9) -> some BinaryConvertible
