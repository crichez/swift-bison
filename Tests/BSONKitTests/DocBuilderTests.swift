...
class DocBuilderTests: XCTestCase {
    ...
    func testTuple7() throws {
        ...
        let content = buildContent()
        let expectedType = Tuple7<Int32, Int64, Double, String, Bool, String?, String>.self
        XCTAssertTrue(type(of: content) == expectedType)

        let encodedContent = try content.encode()
        let expectedEncodedType = Chain7<
            [UInt8], 
            [UInt8], 
            [UInt8], 
            EncodedString, 
    ...
    func testTuple8() throws {
        ...
        let encodedContent = try content.encode()
        let expectedEncodedType = Chain8<
            [UInt8], 
            [UInt8], 
            [UInt8], 
            EncodedString, 
    ...
    func testTuple9() throws {
        ...
        let encodedContent = try content.encode()
        let expectedEncodedType = Chain9<
            [UInt8], 
            [UInt8], 
            [UInt8], 
            EncodedString, 
